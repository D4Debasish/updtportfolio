                ...
                <div className="flex flex-col gap-14 xl:gap-1 xl:flex-row items-center justify-around  ">
                    <div className="text-lg max-w-lg flex flex-col text-center xl:text-left order-2 xl:order-none ">
                        ...
                        <h1 className="text-[40px]  text-accent">
                            <span className=" inline-block w-auto whitespace-nowrap overflow-hidden ">{text} </span>
                        </h1>
                        <p className="text-[14px] items-center mt-4 max-w-[500px]">
                            Results-driven Software Developer with proficiency in React, Next, Node, Express. Love to build stuff and learn
                            about technologies through documentations or by any means.
                        </p>
                        <div className="flex flex-col xl:flex-row items-center gap-8 mt-5 ">
                            <Button variant="outline" size="lg" className="uppercase flex items-center gap-2">
                                <a href="/assets/resume/Debasish.pdf" download="Debasish" className="no-underline font-bold text-xl">
                                    Resume
                                </a>
                                <a href="/assets/resume/DebasishDB.pdf" download="Debasish" className="no-underline font-bold text-xl">
